...
export default function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <Link
      ...
      className="block bg-card rounded-lg p-6 shadow-warm-sm hover:shadow-warm transition-shadow group text-center cursor-pointer border border-card"
    >
      ...
      <span className={`inline-block text-xs px-3 py-1 rounded-lg font-medium ${
