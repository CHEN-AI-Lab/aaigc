      ...
      {password && (
        <div className="space-y-2">
          <div className="relative">
            ...
            <button onClick={() => navigator.clipboard.writeText(password)} className="absolute top-2 right-2 text-xs px-2 py-1 bg-accent text-white rounded-sm hover:opacity-90">{t('copy')}</button>
          </div>
          <div className="flex items-center gap-3">
