...
export default function ColorPicker() {
  ...
  return (
    <div className="mt-6 space-y-6">
      <div className="flex items-center gap-6 p-4 bg-surface rounded-sm border border-border">
        <div className="flex flex-col items-center gap-2">
          <input type="color" value={color} onChange={e => setColor(e.target.value)} className="w-16 h-16 rounded-sm cursor-pointer border border-border" />
