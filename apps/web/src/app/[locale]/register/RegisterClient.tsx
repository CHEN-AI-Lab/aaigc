                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-1.5">
                    <input
                      ...
                      disabled={codeSent}
                      className="flex-1 px-4 py-3 rounded-xl border border-border text-sm text-text-primary placeholder:text-text-secondary/50 focus:outline-none focus:border-accent/50 transition-colors disabled:opacity-50"
                    />
                    <button
                ...
                {codeSent && (
                  <div>
                    ...
                    <button
                      ...
                      className="w-full mt-3 px-4 py-3 rounded-xl bg-accent text-white text-sm font-medium hover:opacity-90 transition-all active:scale-[0.98] disabled:opacity-50"
                    >
