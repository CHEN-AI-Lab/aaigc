import type { ToolCategoryId, CategoryInfo } from '../types'
...
/**
 * 仅返回「至少有一个工具」的分类（P0-12）。
 * `ai` 等暂无工具的分类会被过滤掉，避免出现空的分类区块。
 */
export function categoriesWithTools(list: readonly ToolMeta[] = tools): CategoryInfo[] {
